...
export default function ImageConverter({
  ...
  description =
    "Upload an image and choose the format you want to convert it to.",
      ...
      >
        ...
        <div class="mb-6">
          ...
          >
            ...
            <option value="jpeg" selected={selectedFormat === "jpeg"}>
              JPEG
            </option>
            <option value="webp" selected={selectedFormat === "webp"}>
              WebP
            </option>
          </select>
        </div>
